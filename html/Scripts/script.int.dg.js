...
include('Scripts/jquery.rating.js');
}
...
if(Page=='home'){
$(function(){$('#fluid_dg_wrap_1').fluid_dg({thumbnails: false,height:"44.3%",fx:'scrollLeft,scrollRight,scrollTop,scrollBottom',playPause:'false',minHeight:'0',loader:'none',navigation:'false',hover:'false',time:3000});})
}
