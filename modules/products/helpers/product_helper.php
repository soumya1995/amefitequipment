...
{	
	...
	{
		$CI =& get_instance();
		$stock_qry=$CI->db->query("SELECT SUM(product_stock) as squan FROM wl_products WHERE 1 $cond");//"SELECT SUM(quantity) as squan FROM wl_product_attributes WHERE 1 $cond"
