    ...
    <div class="inner-cont">    
      ...
      <div class="mt40">
        ...
        <div class="col-lg-7 col-md-7 col-sm-12">
          ...
          <?php if(!empty($res['product_length'])){?><p class="mt2 input-w-r"><strong>Lenght:</strong> <?php echo $res['product_length'];?> <?php echo $this->config->item('length_unit');?></p><?php } ?>
...
<p class="clearfix mt10"></p>
         <p class="mt10">
         	 <?php
                      $services = custom_result_set("select service_id, price from tbl_product_services where product_id = '$productId' AND status ='1' ");
...
<?php
         ...
         <div class="service1 serv-cont form_box" >
          ...
          <p class="bb2 mt20"></p>
          <p class="mt15"><a href="#" title="Facebook" class="mr5"><img src="<?php echo theme_url(); ?>images/fb.png" alt="Facebook"></a> <a href="#" title="Twitter"><img src="<?php echo theme_url(); ?>images/tw.png" alt="Twitter"></a></p>
        </div>
        <p class="clearfix"></p>
      </div>
      <p class="mt20 bb"></p>
