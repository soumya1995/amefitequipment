...
?>
<!--Section-->
<div class="container pt20 minmax">
<div class="row">	
    ...
    <p><img src="<?php echo theme_url(); ?>images/arr2.jpg" alt=""></p>
    <p class="lht-22 mt10" style="font-weight:300;"><?php echo char_limiter($content,300);?> </p>
...
<div class="featured-bg minmax">
<div class="container">
<div class="row">
	<p class="new-arrival">New Arrivals</p>
    
    <div class="mt20 o-hid" style="height:510px;">
    <?php
    ...
    <p class="pro"><span><span><a href="<?php echo $link_url;?>" title="<?php echo $alt_tag;?>"><img src="<?php echo $prodImage;?>" alt="<?php echo $alt_tag;?>"></a></span></p>
  ...
  <p class="text-center"><a href="#" onclick="return search_form_submit('new_arrival');" title="Browse More" class="btn-style2">Browse More</a></p>
</div> 
</div>
</div>
	<?php
...
<div class="row">
   ...
   <div class="o-hid" style="height:470px;">
    <?php
    ...
    <p class="mt25 text-center"><a href="#" onclick="return search_form_submit('hot_product');" title="Browse More" class="btn-style2">Browse More</a></p>
</div> 
</div>
	<?php
}?>
...
<div class="row">
	<h2 class="text-center text-uppercase">Featured Products<br><img src="<?php echo theme_url(); ?>images/arr3.png"  alt="" class="mt5"></h2>
    
     <div class="mt10 o-hid" style="height:482px;">
    <?php
	foreach($featured_product as $val){
		...
		$stock_cnt=get_product_stock($cond);
		?>
        <div class="col-lg-2 col-md-3 col-sm-4 p10">
            <div class="probox-sml">
...
<div class="row">
	...
	foreach($brand_res as $val){
		...
		?>
         <div class="col-lg-3 col-md-4 col-sm-6 p10">
        	<p class="brand-pic"><span><a href="#" onclick="return search_form_submit2('product_brand','<?php echo $val['brand_name'];?>');" title="<?php echo $val['brand_name'];?>"><img src="<?php echo $brandImage;?>" alt="Brand Name"></a></span></p>
        </div> 
       <?php
	}?>
    <p class="clearfix"></p>
