<?php $this->load->view('includes/header'); ?>  
 ...
 <div class="box">
    ...
    <?php echo validation_message('');?>
		...
		<?php echo form_open_multipart('sitepanel/currency/add/');?>  
		<div id="tab_pinfo">
			...
			<tr class="trOdd">
				...
				<td width="72%" align="left">
					<input type="text" name="title" size="40" maxlength="32" value="<?php echo set_value('title');?>">
				</td>
			</tr>
			<tr class="trOdd">
				<td width="28%" height="26" align="right" ><span class="required">*</span> Currency Code:</td>
				<td width="72%" align="left">
              <input type="text" name="code" size="40"  maxlength="3" value="<?php echo set_value('code');?>">
				</td>
			</tr>
            <tr class="trOdd">
				<td width="28%" height="26" align="right" ><span class="required">*</span> Currency Symbol:</td>
				<td width="72%" align="left">
              <input type="text" name="symbol" size="40" value="<?php echo set_value('symbol');?>">
				</td>
			</tr>
             <tr class="trOdd">
				<td width="28%" height="26" align="right" ><span class="required">*</span> Currency Value:</td>
				<td width="72%" align="left">
              <input type="text" name="value" size="40" value="<?php echo set_value('value');?>">= 1 USD
				</td>
			</tr>
			<tr class="trOdd">
