   ...
   <div id="tab_pinfo">
    <table width="90%"  class="form"  cellpadding="3" cellspacing="3">
     ...
     <tr class="trOdd">
      ...
      <td align="left"><input type="file" name="image1" id="image1" /><br />Best view image size width : 1600 pixels and height : 566 pixels fixed.</td>
     </tr>
      <tr class="trOdd">
     <td width="28%" height="26" align="right" >Url:</td>
     <td align="left">
      <input type="text" name="header_url" id="header_url" value="" style="width:300px;" />      
     </td>
    </tr>
     <tr class="trOdd">
      <td align="left">&nbsp;</td>
      <td align="left">
       <input type="submit" name="sub" value="Add Header Image" class="button2" />
