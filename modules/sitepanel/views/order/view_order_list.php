	    ...
	    <thead>
	     <tr>
	      <td width="5%" style="text-align: center;"><input type="checkbox" onclick="$('input[name*=\'arr_ids\']').attr('checked', this.checked);" /></td>
				<td width="30%" class="left">Invoice Details</td>
				<td width="15%" class="left">Invoice Amount</td>
				<td width="20%" class="left">Payment Status</td>
			 ...
			 foreach($res as $catKey=>$pageVal){
				 ...
				 <tr>
				  ...
				  <td class="left">
				   ...
				   if($pageVal['customer_type']=='Guest') { echo"( Quick Checkout )"; }?>
				  </td>
