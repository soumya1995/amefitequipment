...
<div class="breadcrumb"> <?php echo anchor('sitepanel/dashbord','Home'); ?>&raquo; <?php echo anchor('sitepanel/city_by_country/index/'.$contID,'Back To Listing'); ?> &raquo;  <?php echo $heading_title; ?> </div>
<div class="box">
	<div class="left"></div>
	<div class="right"></div>
	...
	<div class="content">
		...
		<?php echo form_open('sitepanel/city_by_country/add/'.$contID);?>  
		<div id="tab_pinfo">
			...
			<tr class="trOdd">
				<td align="left">&nbsp;</td>
				<td align="left">
					<input type="submit" name="sub" value="Add Information" class="button2" />
