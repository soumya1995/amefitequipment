...
<div class="content">
 <div id="content">
  <div class="breadcrumb"><?php echo anchor('sitepanel/dashbord','Home'); ?> &raquo; <?php echo anchor('sitepanel/about'.($parent_id==0 ? '' : '/index/'.$parent_id),'Back To Listing'); ?> &raquo; <?php echo $heading_title; ?> </a></div>
  <div class="box">
   <div class="heading">
   ...
   <div class="content">
    ...
    echo error_message();
    echo form_open_multipart("sitepanel/about/add/".$parent_id);?>
    <div id="tab_pinfo">
     <table width="90%"  class="form"  cellpadding="3" cellspacing="3">
      ...
      $default_params = array(
			...
			<?php /*?><tr class="trOdd">
			 ...
			 <td align="left"><input type="file" name="about_image" /><br /><br />[ <?php echo $this->config->item('about.best.image.view');?> ]</td>
			</tr>
			<tr class="trOdd">
			 <td width="28%" height="26" align="right" >Alt :</td>
			 <td align="left"><input type="text" name="about_alt" value="<?php echo set_value('about_alt');?>" /><br /></td>
			</tr>
            <?php */?>
			<tr class="trOdd">
			 <td height="26" align="right"> Description :</td>
			 <td><textarea name="about_description" rows="5" cols="50" id="cat_desc" ><?php echo $this->input->post('about_description');?></textarea> <?php  echo display_ckeditor($ckeditor); ?></td>
			</tr>
			...
			<tr class="trOdd">
			 ...
			 <td align="left">
			  ...
			  if(is_array($parentData)){
				  ?>
				  <input type="hidden" name="parent_id" value="<?php echo $parentData['about_id'];?>" />
				  <?php
			  }?>
			 </td>
			</tr>
