 ...
 <div id="content">
  ...
  <div class="box">
   <div class="heading">
    ...
    <div class="buttons"><a href="<?php echo base_url();?>sitepanel/package/add/" class="button">Add Packing</a></div>
   </div>
   <div class="content">
    <?php
    if(error_message() !=''){
     ...
     <tr>
      <td align="center" >Search [ Title ]
       ...
       if( $this->input->get_post('keyword2')!='' || $this->input->get_post('status')!=''){	      
		       echo anchor("sitepanel/package/",'<span>Clear Search</span>');	      
       }?>
      </td>
		</tr>
		</table>
		...
		<?php echo form_close();?>
		<div class="required"> <?php echo $package_result_found; ?></div>
		<?php
			...
			<table class="list" width="100%" id="my_data">
			 ...
			 // trace($res);	
			  foreach($res as $catKey=>$pageVal){
				  ...
				  ?>
				  <tr>
				   <td style="text-align: center;"><input type="checkbox" name="arr_ids[]" value="<?php echo $pageVal['package_id'];?>" /></td>
				   <td class="left" valign="top"><?php echo $pageVal['title'];?></td>	
                   <td class="center" valign="top"><?php echo display_price($pageVal['price']);?></td>			   
				   <td align="center" valign="top"><img src="<?php echo get_image('package',$pageVal['media'],50,50,'AR');?>" /></td>
				   <td class="center" valign="top">
				    <a href="#"  onclick="$('#dialog_<?php echo $pageVal['package_id'];?>').dialog( {width: 650} );">View Details</a>
                    <div id="dialog_<?php echo $pageVal['package_id'];?>" title="Description" style="display:none;"><?php echo $pageVal['description'];?></div>
				   </td> 
				   <td class="center" valign="top">
				   <?php echo ($pageVal['status']==1)? "Active":"In-active";?>					
				   </td>
				   <td align="center" valign="top">
				    <?php if($this->editPrvg===TRUE)?><p><?php echo anchor("sitepanel/package/edit/$pageVal[package_id]/".query_string(),'Edit');?></p>
				   </td>
				  </tr>
				  <?php
			  }?>
