    ...
    <div id="tab_pinfo">
     <table width="90%"  class="form"  cellpadding="3" cellspacing="3">
      ...
      <?php /*?><tr class="trOdd">
       ...
       <td align="left"><input type="text" name="testimonial_title" style="width:400px;" value="<?php echo set_value('testimonial_title');?>" /></td>
      </tr><?php */?>
      <?php
      ...
      <tr class="trOdd">
       ...
       <td><input type="text" name="email" style="width:400px;" value="<?php echo set_value('email');?>" /></td>
      </tr>
      <tr class="trOdd">
       <td height="26" align="right"> <span class="required">*</span> Comment:</td>
       <td><textarea name="testimonial_description" rows="5" style="width:400px;" id="testimonial_description" > <?php echo set_value('testimonial_description');?></textarea> <?php /*echo display_ckeditor($ckeditor);*/?></td>
      </tr>
      <tr class="trOdd">
       <td align="left">&nbsp;</td>
