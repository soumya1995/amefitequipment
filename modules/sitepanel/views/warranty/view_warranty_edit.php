...
<div class="content">
 <div id="content">
  <div class="breadcrumb"><?php echo anchor('sitepanel/dashbord','Home'); ?> &raquo; <?php echo anchor('sitepanel/warranty','Back To Listing'); ?> &raquo;  <?php echo $heading_title;?></div>
  <div class="box">
   <div class="heading">
    <h1><img src="<?php echo base_url(); ?>assets/sitepanel/image/category.png" alt="" /> <?php echo $heading_title;?></h1>
    <div class="buttons">
     <a href="javascript:void(0);" onclick="$('#form').submit();" class="button">Save</a>
     <?php echo anchor("sitepanel/warranty",'<span>Cancel</span>','class="button"');?>
    </div>
   </div>
   <div class="content">
    ...
    <div id="tab-general">
     <table width="90%"  class="form"  cellpadding="3" cellspacing="3">
      ...
      <tr><th colspan="2" align="center" > </th></tr>
			...
			<tr class="trOdd">
			 <td align="left">&nbsp;</td>
			 <td align="left"><input type="hidden" name="warranty_id" value="<?php echo $res['warranty_id'];?>"></td>
			</tr>
		 </table>
		</div>
		<div id="tab-image">
		 ...
		 <table id="images" class="list">
		  ...
		  <table id="images" class="form">
		   ...
		   for($i=1;$i<=1;$i++){
			   ...
			   $product_path = "warranty/".$product_img;
			   ...
			   <tr>
			    ...
			    <td align="left">
			     ...
			     if( $product_img!='' && file_exists(UPLOAD_DIR."/".$product_path) ){
				     ...
				     <?php if($this->deletePrvg===TRUE){?> | <input type="checkbox" name="warranty_img_delete[<?php echo $product_img_auto_id;?>]" value="Y" />Delete <?php }
