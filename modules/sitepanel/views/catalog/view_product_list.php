				  ...
				  <tr>
				   ...
				   <td align="center" valign="top">
					...
					if($this->editPrvg===TRUE)?>
                        ...
                        <p><?php echo anchor('sitepanel/products/warranty/'.$pageVal['products_id'], 'Manage Warranty', $atts);?><br />
                         <?php echo anchor('sitepanel/products/packages/'.$pageVal['products_id'], 'Manage Package', $atts);?><br />
                         <?php echo anchor_popup('sitepanel/products/related/'.$pageVal['products_id'], 'Add Related Products', $atts);?><br />
