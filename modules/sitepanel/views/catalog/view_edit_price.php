...
<div id="pattr1" <?php if(set_value('type',$type) == 'W'){?> style="display:block;" <?php }else{ ?> style="display:none;" <?php } ?> > 
...
<div  id="pattr2" <?php if(set_value('type',$type) == 'P'){?> style="display:block;" <?php }else{ ?> style="display:none;" <?php } ?>>
 <table width="300" align="left" cellpadding="1" cellspacing="1" class="list">
     <tr class="trOdd">
