...
<li class="active">Payment</li>
    ...
    <p class="black p10 fs16 bdr" style="background:#eee;">1. Delivery Information</p>
      ...
      <div class="mt25">
      <p class="fl w50 mb10"><label><input name="pay_method" type="radio" value="paypal" checked="checked"> <img src="<?php echo theme_url(); ?>images/mycrd1.png" alt="" class="vam"></label></p>
      <p class="fl w50 mb10"><label><input name="pay_method" type="radio" value="paypal" checked="checked"> <img src="<?php echo theme_url(); ?>images/mycrd4.png" alt="" class="vam" ></label></p>
      <p class="fl w50 mb10"><label><input name="pay_method" type="radio" value="paypal" checked="checked"> <img src="<?php echo theme_url(); ?>images/mycrd3.png" alt="" class="vam" ></label></p>
      <p class="fl w50 mb10"><label><input name="pay_method" type="radio" value="paypal" checked="checked"> <img src="<?php echo theme_url(); ?>images/mycrd5.png" alt="" class="vam" ></label></p>
      <p class="fl w50 mb10"><label><input name="pay_method" type="radio" value="paypal" checked="checked"> <img src="<?php echo theme_url(); ?>images/mycrd2.png" alt="" class="vam" ></label></p>
      <p class="cb"></p>
        </div>
        <p class="cb"></p>
