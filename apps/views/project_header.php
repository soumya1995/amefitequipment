...
?>
<!--top-->
<link rel = "stylesheet" type = "text/css" href = "<?php echo base_url()?>css/ame-preet.css"/>
<div class="topbg">
<div class="container">
<div class="row">
  <p class="col-lg-5 col-md-6 col-sm-9 pt3 p0 white">
  <img src="<?php echo theme_url();?>images/top-linkdn.png" alt="Mobile" class="vam mr10"><img src="<?php echo theme_url();?>images/mobile.png" alt="Mobile" class="vam"> <?php echo $this->admin_info->phone;?> 
  <img src="<?php echo theme_url();?>images/email.png" alt="Email ID" class="vam ml15 mr3"> <?php echo $this->admin_info->admin_email;?> </p>
