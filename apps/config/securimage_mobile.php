...
$securimage['gd_font_size'] = 120;
   ...
   * @var string
   */
$securimage['ttf_file'] = APPPATH.'../codeigniter/fonts/texb.ttf';
...
$securimage['text_x_start'] = 8;
   ...
   * @var int
   */
$securimage['text_minimum_distance'] = 16;
...
$securimage['text_maximum_distance'] = 33;
   ...
   * @var string
   */
$securimage['image_bg_color'] = "#cccccc";
